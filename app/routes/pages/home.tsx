    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Ready to continue your educational journey? Here's what you can do today.</p>
        </div>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-200">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Button className="w-full bg-purple-600 hover:bg-purple-700" onClick={handleJoinCommunity}>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">Summarized "Math Basics"</p>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">Joined "Jakarta Teachers"</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                ...
                <p className="text-sm text-gray-600 mb-3">
                  A community for educators in Jakarta to share resources and collaborate.
                </p>
              ...
              <div className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                ...
                <p className="text-sm text-gray-600 mb-3">Sharing innovative math teaching methods and resources.</p>
                <Badge variant="outline" className="text-xs">
                  Active
                </Badge>
              </div>
              ...
              <div className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                ...
                <p className="text-sm text-gray-600 mb-3">Supporting multilingual education across Indonesia.</p>
                <Badge variant="outline" className="text-xs">
                  Active
                </Badge>
              </div>
